<x-app-layout class="bg-perhiasan-tua">
            ...
            <div class="col-span-1 bg-white rounded-xl shadow-md p-6">
                ...
                <table class="min-w-full border-collapse text-sm text-gray-800 border-gray-300">
                    ...
                    <tbody>
                        @forelse ($records as $item)
                            <tr>
                                ...
                                <td class="py-2 px-4 border text-right">
                                    <form method="POST" action="{{ route('perhiasan.tua.gesek.destroy', $item['id']) }}">
                                        @csrf
                                        @method('DELETE')
                        ...
                        @empty
                            <tr><td colspan="4" class="text-center text-gray-500 border">No Data</td></tr>
                        @endforelse
                    </tbody>
                    <tfoot>
    ...
    <div id="inputModalGesek" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center hidden z-50">
        <div class="bg-white rounded-lg shadow-lg w-full max-w-3xl p-6 relative">
            ...
            <form method="POST" action="{{ route('perhiasan.tua.gesek.store') }}" class="space-y-4">
                @csrf
